          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="space-y-6 text-center md:text-left">
              ...
              <p className="text-lg md:text-xl text-foreground font-medium leading-relaxed">
                которые хотят выйти на стабильные продажи, перестать хаотично вести канал и выстроить систему привлечения клиентов
              </p>
              <Button
                size="lg"
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="relative">
            ...
            {[
              ...
              {
                photo: "https://cdn.poehali.dev/projects/f8116922-d831-47a6-b444-7483fbdc7c3e/bucket/01e4b5e2-54a5-401f-9e84-72ec24516adb.jpg",
                name: "Нана Щербакова",
                profession: "Эзотерик, шаманка",
                desc: "Помогает женщинам найти свои сильные стороны, вернуть энергию и жить свою жизнь с доходом через любимое дело."
              },
              {
              ...
              {
                photo: "https://cdn.poehali.dev/projects/f8116922-d831-47a6-b444-7483fbdc7c3e/bucket/c9877b84-5320-43f1-a0bd-a785b50aa89c.jpg",
                name: "Ирина Воловик",
              ...
              {
                photo: "https://cdn.poehali.dev/projects/f8116922-d831-47a6-b444-7483fbdc7c3e/bucket/7a9dabbc-a2f8-4990-bbd7-9ce03efb51d1.jpg",
                name: "Элла и Елена",
              ...
              {
                photo: "https://cdn.poehali.dev/projects/f8116922-d831-47a6-b444-7483fbdc7c3e/bucket/cd83a00a-2b28-45dc-8a17-ee72984a1813.jpg",
                name: "Ирина Галочкина",
                profession: "Косметолог",
                desc: "Помогает женщинам выглядеть свежее, чувствовать себя увереннее и нравиться себе снова — убрать отёки, подтянуть овал и вернуть свежесть через систему ухода."
              }
            ].map((client, i) => (
