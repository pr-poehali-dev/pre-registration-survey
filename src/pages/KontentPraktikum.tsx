    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white overflow-x-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="space-y-6 text-center md:text-left relative z-10">
              ...
              <p className="text-lg md:text-xl text-foreground font-medium leading-relaxed">
                Как превратить посты в систему, которая приводит к продажам даже в маленьком канале
              </p>
      ...
      <section className="relative py-6 px-4 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-4 text-foreground text-base md:text-lg leading-relaxed relative">
          ...
          <p className="font-semibold text-center text-lg md:text-xl text-[#9A1E14]">
            Именно такую систему мы создадим за 14 дней. Не в теории, а прямо в вашем канале!
          </p>
        </div>
      </section>
      ...
      <section className="relative py-6 px-4 bg-white overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-4 relative">
          ...
          <p className="text-base md:text-lg text-foreground leading-relaxed">
            В результате ваш канал перестанет быть набором отдельных публикаций и превратится в понятный маршрут для клиента — от первого интереса до заявки или покупки.
          </p>
          <Card className="relative border-2 border-[#9A1E15] bg-[#9A1E15]/5 shadow-md overflow-visible">
            ...
            <CardContent className="pt-6">
              <p className="font-medium text-center">
                Мы не будем писать тексты «в стол» — уже с первых дней вы начнете публиковать новые посты в своем канале, увидите активность аудитории и выстроите систему, которая начинает работать на продажи.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="relative py-6 px-4 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-3 relative">
          ...
          <Card className="border-2 border-[#9A1E15]/30 shadow-lg bg-white tilt-card">
            <CardContent className="pt-6 space-y-3">
              {[
                "Вы регулярно ведете канал, но продажи появляются от случая к случаю",
                ...
                "Вы понимаете, что даже маленький канал может приносить клиентов, если контент выстроен правильно",
              ].map((item, i) => (
      ...
      <section className="relative py-6 px-4 bg-white overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-3 relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              "Понятная стратегия, какой продукт продавать через канал",
              ...
              "Уже опубликованный прогрев в вашем канале",
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                text: "Каждый день вы получаете новый этап системы контента с готовой структурой поста, примером и заданием, которое сразу внедряете в своем канале.",
              },
              {
                icon: "Bot",
